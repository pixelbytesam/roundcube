...
export const SERVICE_META: ServiceMeta[] = [
  { id: 'web-dev', timeline: '1–12 weeks', startingPrice: '$5,000', teamSize: '2–4', illustration: 'service-web-dev' },
  ...
  { id: 'landing-pages', timeline: '1–3 weeks', startingPrice: '$1,500', teamSize: '1–2', illustration: 'service-landing-pages' },

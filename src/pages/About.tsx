        ...
        >
          ...
          <div className="lg:col-span-7">
            <div className="space-y-5 text-brand-gray-500 text-lg leading-relaxed text-pretty">
              <p>
                NexaBuild started in 2018 when our founders — tired of bloated agencies delivering cookie-cutter software — decided there had to be a better way.
              </p>
              <p>
                We built NexaBuild on a conviction: that small, elite teams shipping with urgency and craft will always outperform large, slow bureaucracies. Every line of code we write reflects that philosophy.
              </p>
              <p>

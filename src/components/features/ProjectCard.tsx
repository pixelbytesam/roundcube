  ...
  return (
    <div className="group bg-white border-2 border-brand-dark rounded-2xl overflow-hidden shadow-brutal transition-all duration-200 hover:-translate-y-1 hover:shadow-brutal-hover">
      ...
      <div className="relative overflow-hidden h-52">
        ...
        {/* CLICKABLE OVERLAY */}
        <a
          href={project.link} // 👈 make sure this exists in your Project type
          target="_blank"
          rel="noopener noreferrer"
          className="absolute inset-0 bg-brand-dark/0 group-hover:bg-brand-dark/60 transition-all duration-300 flex items-center justify-center"
        >
